...
static void put_menu_text(mlx_t *mlx)
{
	...
	mlx_put_string(mlx, "Map color scheme-> 'Z' key", 90, 660);
	mlx_put_string(mlx, "Hendrix color scheme-> 'X' key", 65, 680);
	mlx_put_string(mlx, "Polarity color scheme-> 'C' key", 60, 700);
	mlx_put_string(mlx, "Exit -> ESC key", 150, 740);
}